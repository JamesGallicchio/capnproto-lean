...
This file contains a Lean specification of the Cap'n'Proto Schema.
Eventually it will be bootstrapped,
i.e. autogenerated from a .capnp file that specifies it.
-/
